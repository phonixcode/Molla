...
@section('content')
    ...
    <div class="checkout_area section_padding_100">
        <div class="container">
            <form action="{{ route('checkout.three.store') }}" method="post">
                @csrf
                <div class="row">
                    <div class="col-12">
                                ...
                                <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                                    ...
                                    <div class="panel panel-default">
                                        ...
                                        <div aria-expanded="false" id="collapse_five" class="panel-collapse collapse"
                                            ...
                                            <div class="panel-body">
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" required value="cod" name="payment_method" class="custom-control-input" id="customCheck2">
