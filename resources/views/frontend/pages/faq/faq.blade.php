...
@section('content')
 ...
 <section class="faq_quesition_search_area section_padding_100 bg-img bg-overlay" style="background-image: url({{ asset('frontend/img/bg-img/1.jpg') }});">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-12 col-md-9 col-lg-6">
                <div class="faq_quesition_search_form">
                    <h2>How can help you?</h2>
                    <form action="javascript:void(0)" method="get" class="faq_form">
        ...
        <div class="row">
            <div class="col-12">
                <div class="cannot_find_text text-center">
                    <h3 class="mb-3">Can't find answer? Submit a Request.</h3>
                    <i class="icofont-live-support"></i>
                    <a href="javascript:void(0)" class="btn btn-primary">Submit A Request</a>
                </div>
            </div>
        </div>
    </div>
