                ...
                <div class="col-md-12 m-b-30">
                    ...
                    <div class="d-block d-sm-flex flex-nowrap align-items-center">
                        <div class="page-title mb-2 mb-sm-0">
                            <h1>
                                Brands
                                <a href="{{ route('brand.create') }}" class="ml-2 btn btn-outline-warning btn-icon-text">
                                            ...
                                            <td style="white-space: nowrap; width: 1%;">
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenu2">
                                                        <a href="{{ route('brand.edit', $item->slug) }}" class="dropdown-item"><i class="ti ti-pencil pr-2 text-primary"></i>Edit</a>
                                                        <form action="{{ route('brand.destroy', $item->slug) }}"
                                                            method="post">
                                                            @csrf
                                                            @method('delete')
                                                            <a class="dltBtn dropdown-item"
                                                                href="{{ route('brand.destroy', $item->slug) }}"
