                ...
                <div class="col-md-12 m-b-30">
                    ...
                    <div class="d-block d-sm-flex flex-nowrap align-items-center">
                        <div class="page-title mb-2 mb-sm-0">
                            <h1>
                                Shippings
                                <a href="{{ route('shipping.create') }}" class="btn btn-outline-warning btn-icon-text">
                            ...
                            <nav>
                                <ol class="breadcrumb p-0 m-b-0">
                                    <li class="breadcrumb-item">
                                        Total Shippings: {{ count($shippings) }}
                                    </li>
                                </ol>
                            </nav>
                        </div>
                                            ...
                                            <td style="white-space: nowrap; width: 1%;">
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenu2">
                                                        <a href="{{ route('shipping.edit', $item->uuid) }}" class="dropdown-item"><i class="ti ti-pencil pr-2 text-primary"></i>Edit</a>
                                                        <form action="{{ route('shipping.destroy', $item->uuid) }}"
                                                            method="post">
                                                            @csrf
                                                            @method('delete')
                                                            <a class="dltBtn dropdown-item"
                                                                href="{{ route('shipping.destroy', $item->uuid) }}"
