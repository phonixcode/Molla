                            ...
                            <div class="col-md-8 text-center">
                                <div class="error-text">
                                    <svg version="1.1" xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        height="100%" viewBox="0 0 398.1 226.6"
                                            ...
                                            c-28.1-25.2-68.7,4.8-97.3,14.2C140.7,39.6,92.8,52.6,45.6,67.8z" />
                                                <g>
                                                    <g>
                                                        <g>
                                                            <path class="st1"
                                                                d="M154.3,145.1c-4.6-7.7-11.6-10.6-18-10.5c-5.1,0-10.4,1.7-15.1,4.5c-2.3,1.3-4.8,3.3-4.8,3.3c0,0,0,0,0,0
                                                    ...
                                                    <g>
                                                        <g>
                                                            <path class="st1"
                                                                d="M290.2,105.5c-12.3-7.5-27.9-1.8-40.4,18.5c-12.1,20.1-10.9,36.1,0.9,43.4c13.4,8.2,28,1.6,40.7-19
                                                ...
                                                <g>
                                                    ...
                                                    <ellipse
                                                        ...
                                                        class="st5" cx="258.9" cy="180.2" rx="10.6"
                                                        ry="4.7" />
                                                    <path class="st11"
                                    ...
                                    <a href="{{ route('home') }}" class="btn btn-round btn-primary mt-3">Back to Home</a>
                                </div>
                            </div>
                        </div>
                    </div>
